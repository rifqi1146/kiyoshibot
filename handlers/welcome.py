...
WELCOME_ENABLED_CHATS = globals().get('WELCOME_ENABLED_CHATS', set())
VERIFIED_USERS = globals().get('VERIFIED_USERS', {})
PENDING_VERIFY = globals().get('PENDING_VERIFY', {})
PENDING_VERIFY_TASKS = globals().get('PENDING_VERIFY_TASKS', {})
WELCOME_MESSAGES = globals().get('WELCOME_MESSAGES', {})
VERIFY_LOCKS = globals().get('VERIFY_LOCKS', {})
VERIFY_LOCK_TIMES = globals().get('VERIFY_LOCK_TIMES', {})
VERIFY_TOKENS = globals().get('VERIFY_TOKENS', {})
VERIFY_TOKEN_TIMES = globals().get('VERIFY_TOKEN_TIMES', {})
BOT_INSTANCE = globals().get('BOT_INSTANCE', None)
